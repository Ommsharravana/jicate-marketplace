...
Standard HTML/CSS, Vercel deployment, and Firecrawl usage are assumed knowledge — this skill covers the playbook-specific workflow, content structure, and quality gates.

## CRITICAL: Mode Routing (Read This First)

> **Industry mode = V2 (8 sections). ALWAYS. NO EXCEPTIONS.**
> **Company mode = V1 (13 sections). ALWAYS.**
>
> If the user asks for an industry playbook, you MUST use `references/phase-2-content-v2.md` (8 emotional sections).
> NEVER use `references/phase-2-content.md` (13 technical sections) for industry playbooks.
> The 13-section structure is ONLY for company mode (`--company` flag).
